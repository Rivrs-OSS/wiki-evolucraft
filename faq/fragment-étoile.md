---
description: Retrouvez ici toutes les informations concernant les fragments d'étoiles de métiers
---
...
{% hint style="info" %}
Si vous souhaitez plus d'informations sur le **<mark style="color:green;"><strong>classement des villes</strong></mark>**, nous vous renvoyons vers cette page du wiki : **<mark style="color:green;"><strong>[🏆 Le Classement des Villes](https://wiki.evolucraft.fr/le-gameplay/les-villes/classement-ville)</strong></mark>**
{% endhint %}
